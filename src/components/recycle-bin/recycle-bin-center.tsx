  ...
  return (
    <div className="space-y-6 select-none relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        {/* Table & Cards (Left) */}
        <div className={cn("space-y-4", detailItemId ? "lg:col-span-3" : "lg:col-span-4")}>
          {paginatedList.length === 0 ? (
            ...
            <>
              {/* Desktop Table View */}
              <div className="hidden md:block rounded-xl border border-border/60 bg-card/45 backdrop-blur-xs overflow-x-auto">
