...
export interface SettingsState {
  ...
  // Intelligent AI Automation Triggering (Phase 2.2)
  aiAutoLectures: boolean;
  aiAutoNotes: boolean;
  aiAutoPresentations: boolean;
  aiAutoAssignments: boolean;
  aiAutoQuizzes: boolean;
  aiAutoProjects: boolean;
  aiAutoLabs: boolean;
  aiAutoPastPapers: boolean;
...
const DEFAULT_SETTINGS = {
  ...
  rememberHabits: true,
  // Intelligent AI Trigger defaults
  aiAutoLectures: true,
  aiAutoNotes: true,
  aiAutoPresentations: true,
  aiAutoAssignments: false,
  aiAutoQuizzes: false,
  aiAutoProjects: false,
  aiAutoLabs: false,
  aiAutoPastPapers: false,
      ...
      resetSection: (section) => {
        ...
        switch (section) {
          ...
          case "ai":
            ...
            resetData.aiAutoLectures = DEFAULT_SETTINGS.aiAutoLectures;
            resetData.aiAutoNotes = DEFAULT_SETTINGS.aiAutoNotes;
            resetData.aiAutoPresentations = DEFAULT_SETTINGS.aiAutoPresentations;
            resetData.aiAutoAssignments = DEFAULT_SETTINGS.aiAutoAssignments;
            resetData.aiAutoQuizzes = DEFAULT_SETTINGS.aiAutoQuizzes;
            resetData.aiAutoProjects = DEFAULT_SETTINGS.aiAutoProjects;
            resetData.aiAutoLabs = DEFAULT_SETTINGS.aiAutoLabs;
            resetData.aiAutoPastPapers = DEFAULT_SETTINGS.aiAutoPastPapers;
            resetData.aiAssessmentRememberedChoice = DEFAULT_SETTINGS.aiAssessmentRememberedChoice;
            break;
          case "planner":
